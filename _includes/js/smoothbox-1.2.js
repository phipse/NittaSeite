...
function TB_show(caption, url, rel){
    ...
    if (!$("TB_overlay")) {
        new Element('iframe').setProperty('id', 'TB_HideSelect').injectBefore($('container'));
        $('TB_HideSelect').setOpacity(0);
        new Element('div').setProperty('id', 'TB_overlay').injectBefore($('container'));
        $('TB_overlay').setOpacity(0);
        TB_overlaySize();
        new Element('div').setProperty('id', 'TB_load').injectBefore($('container'));
        $('TB_load').innerHTML = "<img src='static/images/loading.gif' />";
        TB_load_position();
    ...
    if (!$("TB_window")) {
        new Element('div').setProperty('id', 'TB_window').injectBefore($('container'));
    ...
    if (baseURL.match(imageURL)) {
        ...
        imgPreloader.onload = function(){
            ...
            $("TB_window").innerHTML += "<a href='' id='TB_ImageOff' title='Close'><img id='TB_Image' src='" + url + "' width='" + imageWidth + "' height='" + imageHeight + "' alt='" + caption + "'/></a>" + "<div id='TB_caption'>" + caption + "<div id='TB_secondLine'>" + imageCount + prev.html + next.html + "</div></div><div id='TB_closeWindow'><a href='#' id='TB_closeWindowButton' title='Schlie&szlig;en'>schlie&szlig;en</a></div>";
